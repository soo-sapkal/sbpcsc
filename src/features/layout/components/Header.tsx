    ...
    <div className="container mx-auto px-4">
      <div className="flex items-center justify-center py-5 md:justify-between">
        ...
        <div className="w-full text-center md:w-[75%]">
          <div className="text-brand text-lg font-bold md:text-[1.313rem] tracking-wide">
            Pimpri Chinchwad Education Trust&apos;s
          </div>
          <div className="text-accent text-2xl font-bold md:text-3xl uppercase tracking-wide py-1">
            S. B. PATIL COLLEGE OF SCIENCE AND COMMERCE
          </div>
          <div className="text-muted-foreground text-xs md:text-[0.938rem]">
